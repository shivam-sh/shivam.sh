...
<p>
  <a href="https://github.com/shivam-sh/shivam-sh.github.io/tree/master/Resources/assets/a*" class="button">
    View Source
  </a>
  <a href="https://shivam-sh.github.io/assets/a*/" class="button">
    Fullscreen
  </a>
</p>
...
export default ({children}) => <BlogPost meta={meta} content={children}/>
